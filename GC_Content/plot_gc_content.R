...
orf <- read.fasta("fly_dm6_ucsc.fa.transdecoder.cds", set.attributes = F)
...
orf <- read.fasta("zebrafish_danRer11_ucsc.fa.transdecoder.cds", set.attributes = F)
geneorf_df <- GetCodonFrequency(geneorf)
...
orf <- read.fasta("human_hg38_ucsc.fa.transdecoder.cds", set.attributes = F)
geneorf_df <- GetCodonFrequency(geneorf)
...
orf <- read.fasta("mouse_mm10_ucsc.fa.transdecoder.cds", set.attributes = F)
geneorf_df <- GetCodonFrequency(geneorf)
